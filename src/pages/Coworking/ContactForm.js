                        ...
                        <Row className="align-items-center">
                            <Col lg={8} md={7}>
                                <div className="section-title mr-lg-4">
                                    ...
                                    <p className="text-light para-desc mb-0">Start working with <span className="text-success font-weight-bold">SFLY</span> that can provide everything you need to generate awareness, drive traffic, connect.</p>
                                </div>
                            </Col>
