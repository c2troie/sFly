...
const Newsletter = () => {
  ...
  const URL = `http://localhost:${process.env.PORT || 8080}/send-email?email=${email}`
 ...
 {/* Alert */}
      ...
      <div className="container mt-100 mt-60">
        ...
        <Row className="justify-content-center mt-4 pt-2">
          <Col lg={7} md={10}>
          <Alert color="success" isOpen={contactvisible} toggle={()=>setContactvisible(!contactvisible) } fade={true}>
                                           Merci !
                                         </Alert>
