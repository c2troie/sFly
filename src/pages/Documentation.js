                ...
                <section className="section">
                    <div className="container">
                        <Row>
                            <Col>
                                <h1>Introduction</h1>
                                <p className="text-muted h5 font-weight-normal">Get Start With <span className="text-primary font-weight-bold">SFLY</span> in React Js. Launch your campaign and benefit from our expertise on designing and managing conversion centered bootstrap4 React js page.</p>

                                <h3 className="mt-4 pt-2">Quick start</h3>

                                <p className="text-muted">Start working with <span className="text-primary font-weight-bold">SFLY</span> that can provide everything you need to generate awareness, drive traffic, connect. <Link to="//reactjs.org/docs/create-a-new-react-app.html" target="_blank" className="text-primary h6">Head to the CRA installation page.</Link></p>
                                ...
                                <p className="text-muted">The zip file contains all js files integrated with SFLY, however you need to perform following steps to get node_modules etc. Make sure you have installed node and its version is greater then 9. You can simply switch your current node version using nvm (Node version manager). </p>
